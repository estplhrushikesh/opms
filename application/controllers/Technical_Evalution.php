...
public function manage(){
		...
		if(!empty($data['technical_evalution_data'])){
           ...
           $data['technical_evalution_data'] = $this->Technical_evalution_model->technical_evalution_data($project_id);
            ...
            $data['prequalification_data'] = $this->Technical_evalution_model->prequalification_data($project_id);
         }
		...
		$bidder_mark = $this->input->post('bidder_mark');
		$tech_qualified = $this->input->post('technical_status');
		$tech_QCBS_score = $this->input->post('bidder_score');
		$tech_weighted_score = $this->input->post('bidder_weighted_score');
		...
		'technical_mark' => $bidder_mark[$i],
		'bidder_score' => $tech_QCBS_score[$i],
		'bidder_weighted_score' => $tech_weighted_score[$i],
