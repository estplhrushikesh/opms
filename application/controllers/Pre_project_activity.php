...
class Pre_project_activity extends MY_Controller
{   
    ...
    public function project_lists()
    {
        ...
        $this->load->common_template('pre_project_activity/pre_consttruction_activity_list', $data);
    }
    ...
    public function settings()
    {
        ...
        if($getsettings) {
          ...
          $this->load->common_template('pre_project_activity/pre_consttruction_activity_settings', $data);
        }
        else {
            $this->load->common_template('pre_project_activity/pre_consttruction_activity_settings', $data);
        }
    ...
    public function savesettings() {
            ...
            if(count($_POST) == 1) {
              ...
              redirect('pre_project_activity/settings?project_id='.$project_id);  
            }
            else {
            $data = array(
