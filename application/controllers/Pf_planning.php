...
class Pf_planning extends MY_Controller
{
    ...
    public function add_project_activity(){
        ...
        if(!empty($_REQUEST['submit'])){
            ...
            $project_activity['stage_status']='N';
    ...
    /*Financial Listing*/
  public function planned_value($pid){
    $project_aggrement_deatail = $this->Pf_planning_model->get_project_aggrement_details($pid);
    $cost=$project_aggrement_deatail[0]['agreement_cost'];
       $result= $this->Pf_planning_model->project_planned_value($pid);
       $total=0;
       foreach($result as $rs){
            $total+=$rs['financial_amount'];
       }
    ...
    public function financial_listing(){
       ...
       $data['project_deatail'] = $this->Pf_planning_model->project_details($project_id);
       $data['fetch_deliverables'] = $this->Pf_planning_model->fetch_deliverables($project_id,$project_work_item_id);
      //  $data['fetch_deliverables'] = $this->Monitoring_model->get_project_physical_activity_details($project_id,$project_work_item_id);
        
        $data['project_aggrement_deatail'] = $this->Pf_planning_model->get_project_aggrement_details($project_id);
        $data['project_financial_activity_deatail'] = $this->Pf_planning_model->get_project_financial_activity_details($project_id,$project_work_item_id);
       // echo "<pre>";
        //print_r($data['project_financial_activity_deatail']);
       // exit;
        ...
        //  echo "<pre>";
      //  print_r($data['fetch_deliverables']);
       //exit;
       $this->load->common_template('project/pf_financial_listing',$data);
    }
    /*Financial Listing End*/

    function get_activity_all_or_not($pid,$wid){
        return $this->Pf_planning_model->activity_all_or_not($pid,$wid);
        }
        function get_activity_all_or_not_physical($pid,$wid){
            return $this->Pf_planning_model->activity_all_or_not_physical($pid,$wid);
            }

        function get_deliverable_row($pid,$wid){
            return $this->Pf_planning_model->activity_added_or_not($pid,$wid);
        }
    ...
    public function add_financial_planning(){
        ...
        if(!empty($_REQUEST['submit'])){
           ...
           $activitiesremaining_amt = $get_activities_budget_amt - $get_activities_planned_amt;
            ...
            $financial_planning['project_work_item_id']=$_REQUEST['project_work_item_id'];
            $financial_planning['deliverable_name']=$_REQUEST['deliverable_name'];
            $financial_planning['project_activity_id']=$_REQUEST['deliverable_name'];
            $financial_planning['milestone_name']=$_REQUEST['milestone_name'];
            $financial_planning['weightage']=$_REQUEST['weightage'];
            $financial_planning['financial_amount']=$_REQUEST['amount'];
            ...
            if(empty($_REQUEST['project_financial_id'])){
                ...
                echo $_REQUEST['project_work_item_id'];
                echo $_REQUEST['deliverable_name'];
                $financial=$this->Pf_planning_model->get_financial_main_da($_REQUEST['project_id'],$_REQUEST['project_work_item_id'],$_REQUEST['deliverable_name']);
                
               // print_r($financial);
                //exit;
                $wp=0;
                  // $remaining=0;
                foreach($financial as $da){
                       $wp+=$da['weightage'];
               ...
               //  echo $wp;
                // exit;
                 $remaining=100-$wp;
                 if($_REQUEST['weightage']<= $remaining){
                    ...
                    redirect('pf_planning/financial_listing?project_id='.base64_encode($_REQUEST['project_id']).'&project_work_item_id='.base64_encode($_REQUEST['project_work_item_id']));       
    ...
    public function physical_listing(){
       ...
       $data['project_deatail'] = $this->Pf_planning_model->project_details($project_id);
       $data['project_aggrement_deatail'] = $this->Pf_planning_model->get_project_aggrement_details($project_id);
       $data['project_activity_deatail_update'] = $this->Pf_planning_model->get_added_activity($project_id,$project_work_item_id);
      
       $data['project_activity_deatail_add'] = $this->Pf_planning_model->get_new_activity($project_id);
        //echo "<pre>";
      // print_r($data['project_activity_deatail_add']);
      // exit;
    ...
    public function add_physical_planning(){
       ...
       $data['project_aggrement_deatail'] = $this->Pf_planning_model->get_project_aggrement_details($project_id);
        ...
        if(!empty($_REQUEST['submit'])){
            ...
            $physical_planning['startdate']=$_REQUEST['startdate'];
            $physical_planning['adddays']=$_REQUEST['adddays'];
            $physical_planning['enddate']=$_REQUEST['enddate'];
            ...
            if(empty($_REQUEST['project_physical_id'])){
               ...
               $this->session->set_flashdata('message', 'Data Added Successfully');
               $update_status=$this->Pf_planning_model->update_state_status('project_pf_activities',$_REQUEST['project_id'],$_REQUEST['activity_id']);
            }else{
...
public function delete_physical_planning(){
    $project_id = base64_decode($_REQUEST['project_id']);
    $work_item_id = base64_decode($_REQUEST['project_work_item_id']);
    $activity_id = base64_decode($_REQUEST['project_activity_id']);
    $this->Pf_planning_model->delete_physical_added_activity('project_physical_planning_main',$project_id,$work_item_id,$activity_id);
       $data['stage_status']='N';
      
    $this->Pf_planning_model->update_physical_activity_status('project_pf_activities',$activity_id,$data);
    $this->session->set_flashdata('danger', 'Data deleted Successfully');
    redirect('pf_planning/physical_listing?project_id='.base64_encode($project_id).'&project_work_item_id='.base64_encode($work_item_id));
