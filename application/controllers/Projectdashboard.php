...
/* for project pre construction details view new code start on 27-04-2021 */
  function project_pre_construction_details_ajax_data(){
        ...
        if($type == 'gov_land_alienation'){
            ...
            $gov_land_alienation_data = $this->Projectdashboard_model->fetch_Pre_Construction_Activities_details_single_data('pre_project_activity_erp', 'project_id', $project_id);
        ...
        if($type == 'private_land_dp'){
            $private_land_dp_data = $this->Projectdashboard_model->fetch_Pre_Construction_Activities_details_single_data('pre_project_activity_mis', 'project_id', $project_id);
