...
class Pre_project_activity_erp extends MY_Controller
{   
    ...
    public function manage()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->common_template('pre_project_activity/pre_project_activity_erp', $data);
 ...
 //    }
    ...
    $this->Land_alienation_model->addLandalianation_location($addData);
		 ...
		 if($project_id){
                ...
                redirect('Pre_project_activity_erp/manage?project_id=' . base64_encode($project_id));
            }
