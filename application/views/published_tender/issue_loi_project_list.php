...
<section class="content">
        ...
        <div class="block-header">
          <h4>Project Tendering - Issue of LoI</h4>
        </div>
            </div>
            <div class="col-md-6">
								  ...
								  $status_view = "In Progress";
                                      ...
                                      ?>
                                        <tr>
                                            ...
                                            <a class="btn bg-primary waves-effect" title="" href="<?php echo base_url();?>Issue_of_LoI/manage?project_id=<?php echo base64_encode($app->project_id); ?>">
