                            ...
                            <div class="row clearfix">
                               <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control chronly" name="department_id" type="text" value="<?php if(empty($get_landalienation)){ echo set_value('department_id'); }?><?php echo $get_landalienation[0]['department_id'] ?>" placeholder="Department Budget">
                                </div>

                                <div class="col-md-4">
                                    <p>
                                        <b>Department Stakeholder</b>
                                    </p>
                                    <?php echo form_error('department_id', '<div class="error">', '</div>'); ?>
                                    <input class="form-control chronly" name="status_alienation_proposed" type="text" value="<?php if(empty($get_landalienation)){ echo set_value('status_alienation_proposed'); }?><?php echo $get_landalienation[0]['status_alienation_proposed'] ?>" placeholder="Department Stakeholder">
                                </div>
