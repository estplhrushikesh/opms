    <section class="content">
        ...
        <div class="block-header">
             <h4>Pre Project Activities Settings </h4>
          </div>
    <!-- Alert Message -->
    <div class="row">
    ...
    <!-- Steps end --> 
      ...
      <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2> Applicable Pre-Project Activities  </h2>
                        </div>
                  ...
                  if (isset($getsettings[0]['project_id'])) { 
                         echo form_open('Pre_project_activity/updatesettings',array('name'=> 'Pre_consttruction_activity'));
                       }
                       else {
                         echo form_open('Pre_project_activity/savesettings',array('name'=> 'Pre_consttruction_activity'));
                          }
                        ?>
                        <input type="hidden" name="project_id" value="<?php echo $project_id; ?>">
                              <div class="col-md-12">   
                                <h2 class="card-inside-title"> Select All Applicable Pre-Project Activities </h2>  
                                 <div class="row clearfix">
                                  <div class="col-md-4 m-t-15">
                                    <label class="lbl-txt">Software Related</label>
                                    <div class="demo-checkbox">
                                        ...
                                        <label for="basic_checkbox_3"> ERP </label>
                                    </div>
                                    <div class="demo-checkbox">
                                        ...
                                        <label for="basic_checkbox_4"> MIS  </label>
                                    </div>
                                    <div class="demo-checkbox">
                                        ...
                                        <label for="basic_checkbox_5"> Website </label>
                                    </div>
                                    <div class="demo-checkbox">
                                        ...
                                        <label for="basic_checkbox_6"> WebPortal  </label>
                                    </div>
                                  </div>
                                <div class="col-md-4 m-t-15">
                                  <label class="lbl-txt">Hardware Related</label>
                                    <div class="demo-checkbox">
                                        ...
                                        <label for="basic_checkbox_9"> Building Availability </label>
                                    </div>
                                    <div class="demo-checkbox">
                                        ...
                                        <label for="basic_checkbox_10"> Site Readiness </label>
                                    </div>
                                    <div class="demo-checkbox">
                                        ...
                                        <label for="basic_checkbox_11"> Power Backup </label>
                                    </div>
                                </div>
                                  <div class="col-md-4 m-t-15">
                                    <label class="lbl-txt">Cloud Related</label>
                                   <div class="demo-checkbox">
                              <input type="checkbox" name="tree_cut" id="basic_checkbox_7" class="filled-in" value="Y" <?php echo ($getsettings[0]['tree_cutting']== 'Y' ? 'checked' : '');?> />
                                        <label for="basic_checkbox_7"> Infrastructure  </label>
                                    </div>
                                    <div class="demo-checkbox">
                                        ...
                                        <label for="basic_checkbox_8"> Licence Availability </label>
                                    </div>   
