...
<a class="navbar-brand" href="#"><img src="<?php echo base_url();?>assets/images/ocac_logo.png"/ class="img-responsive" ></a>
...
<!-- <li class="logged_in">Logged in as : <?php echo $this->session->userdata('username');?> -->
	...
	<li class="logged_in">Logged in as : <?php echo $this->session->userdata('user_f_name');?>
<?php
//echo "<pre>";
