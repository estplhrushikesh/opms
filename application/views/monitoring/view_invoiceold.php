                        ...
                        <div class="col-md-6 col-md-offset-3 p-0">
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td> Construction India Pvt. Ltd. </td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                                        ...
                                        <td>
                                            <table class="table table-bordered table-striped m-b-0">
                                                ...
                                                <tbody>
                                                                                                <tr>
                                                    <td>Development  </td>
                                                    <td> <i class="fa fa-rupee-sign"></i> 25000.00</td>
                                                    <td> <i class="fa fa-rupee-sign"></i> 10000.00</td>
                                                    <td> <i class="fa fa-rupee-sign"></i> 0.00</td>
                                                    <td> </td>
                                                </tr>
                                        ...
                                        <td>
                                            <table class="table table-bordered table-striped m-b-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <td>Development  </td>
                                                    <td> <i class="fa fa-rupee-sign"></i> 25000.00</td>
                                                    <td> <i class="fa fa-rupee-sign"></i> 15000.00</td>
                                                    <td> <i class="fa fa-rupee-sign"></i> 10000.00</td>
                                                    <td> </td>
                                                </tr>
