                        ...
                        <div class="section_clone">
                            <div class="row clearfix cloneBox1">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="hidden" id="project_id" name="d" value="<?php echo $project_id; ?>">
                                            ...
                                            <input type="text" id="invoice_no" name="invoice_no" class="form-control" placeholder="Invoice No"required>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-line">
                                            <input type="text" id="invoice_date" name="invoice_date" class="datepicker form-control" placeholder="Invoice Date" data-dtp="dtp_MLfId" required>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-line">
                                            <input type="number" id="total_invoice_amount"  name="invoice_value" class="form-control" placeholder="Claimed Amount" required>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
