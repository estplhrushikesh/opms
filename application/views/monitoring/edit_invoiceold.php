      ...
      <?php } ?>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form action="https://pmis.estpl.net/projectInvoice/add_invoice" name="add_invoice" id="add_invoice" method="post" accept-charset="utf-8">
                        <input type="hidden" name="project_id" value="MjU=">
                                    ...
                                    <div class="col-md-4">
                                        <select id="invoice_vendor" name="vendor" class="form-control show-tick">
                                            <option value="">Select Vendor</option>
                                                                                            <option value="10">ABC Infra Limited</option>
                                                                                            <option value="11">Xyz Consulting Limited</option>
                                                                                            <option value="12">Road Construction India Pvt. Ltd.</option>
                                                                                            <option value="13">Construction India Pvt. Ltd.</option>
                                                                                    </select>
                                    </div>
                                </div>
