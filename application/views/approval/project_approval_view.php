                        ...
                        <div class="header">
                         <?php 
								...
								elseif ($stage_id == 3) { // DPR
								 $fund_lebel ="Fund Alloted For Project Execution";
								 $fund_text ="Fund Alloted For  Project Execution";
								 $fund_heading ="status of DPR";
									
								}
								elseif ($stage_id == 4) { // Pre-Project  Activities
								 $fund_lebel ="Fund Alloted For Administrative Approval";
								 $fund_text ="Fund Alloted For Administrative Approval";
								 $fund_heading ="Pre Project Activities";
