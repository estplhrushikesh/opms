                           ...
                           <div class="section_clone">  
                            <div class="row clearfix">
                                ...
                                <div class="col-md-4">
                                    <p>
                                        <b>Department</b>
                                            ...
                                            <select class="form-control" id="project_wing_id">
                                ...
                                <div class="col-md-4 text-center">
                                  ...
                                  <button class="btn bg-indigo waves-effect" style="margin-top:25px;"  onclick="clickFunction();" type="button">
            ...
            <div id="dash_area">
               ...
               <div class="row clearfix">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <div class="card">
                            <!-- <div class="header">
                                <h2>Dashboard report on Inordinate Delays</h2>
                            </div> -->
                            <div class="body">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <div class="card">
                            ...
                            <div class="body">
                                <!-- <div id="bar_chart" height="150"></div> -->
                                <div id="project-progress" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
                            </div>
                        </div>
                    </div>
...
function PCtype_button(fired_button) {
   ...
   function workitem_progress()
    ...
    title: {
        align: 'center',
        text: 'Dashboard report on Inordinate Delays'
    },
    ...
    function allprojectstatus(){

        Highcharts.chart('project-progress', {
    chart: {
        plotBackgroundColor: null,
        plotBorderWidth: null,
        plotShadow: false,
    ...
    title: {
        text: 'Project Progress By Stages'
    },
    tooltip: {
