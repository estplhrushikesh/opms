    ...
    <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                ...
                <tr>
                    ...
                    <td><?php echo $gov_land_alienation_data[0]['activity_status']; ?></td>
                </tr> 
                <tr>
