   <?php  $CI =& get_instance(); ?>
    ...
    ?> 
           ...
           <input type="hidden" name="project_id" value="<?php echo base64_encode($project_id); ?>" />
                  ...
                  <div class="card">
                    <div class="header">
                            <h2> Bidder Information- Financial </h2>
                        </div>
                        <div class="body">
                              ...
                              <div class="table-responsive">
                                <table id="project_approval_list" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                      ...
                                      $i = 1;
                                      if(is_array($financial_evalution_data)){
                                        foreach ($financial_evalution_data as $app) {  
                                      ?>
                                        <tr>
                                            <td><?php echo $i; ?></td>
                                            <td><?php echo $app['bidder_name']; ?></td>
                                            <td><?php  echo number_format($app['bid_value'],2); ?></td>
                                            <td><?php echo$app['successful_bidder']; ?></td>
                                            <td><?php echo $app['final_score'];; ?>
                                            </td>  
