                                     ...
                                     <div class="body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input class="form-control bidderrefno " type="text" id="biddername<?php echo $k ?>" value="<?php echo $Tvalue['bidder_info']; ?>"  name="bidder_info[]" placeholder="Bidder Contact Info" >
                                                <?php echo form_error('bidder_info[]', '<div class="error">', '</div>'); ?>
                                            </div>

                                            <div class="col-md-5 p-0">
                                                <p><b>Attachment</b>(File type pdf,jpg,gif,docs and max 50mb)
                                                </p>
                                                <input  class="form-control upload_file" type="file" name="prebid_querydoc[]"  id="biddername<?php echo $k ?>">
                                                   <?php if (!empty($Tvalue['document_name'])) { ?>
                                                    <a href="<?php echo base_url();?>uploads/files/prebid/<?php echo $Tvalue['document_name']; ?>" title="Download" download>
                                                      <i class="fa fa-download fa-2x" aria-hidden="true"></i>
                                                    </a>
                                                  <?php } ?>

                                                  <input type="hidden" name="prebid_querydoc_hidden[]" value="<?php echo $Tvalue['document_name']; ?>" />
                                            </div>
...
<!-- ============================== -->
                  ...
                  <!-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p-0">
                        <div class="card clearfix">
                             <div class="header">
                                 <h2> Attachment-Pre-Bid Query </h2>
                             </div>
                            <div class="body clearfix">
                                <div class="clearfix  m-b-15">
                                    <div class="upload-query-container">

                                   <?php
                                     if(!empty($prebid_query_file)){
                                    ?>

                                    <?php 
                                      $k = 1;
                                      $get_same_datacnt2 = count($prebid_query_file);
                              
                                      foreach ($prebid_query_file as $filenamevalue) {
                                      if($k == 1){
                            
                                    ?>
                                      <div class="row">
                                             <div class="col-md-6 p-0">
                                                <p><b>Attachment</b>(File type pdf,jpg,gif,docs and max file size 50mb)
                                                </p>
                                                <input  class="form-control upload_file" type="file" name="prebid_querydoc[]"  id="uploadFile<?php echo $k ?>">
                                                  ...
                                                  <input type="hidden" name="prebid_querydoc_hidden[]" value="<?php echo $filenamevalue['document_name']; ?>" />
                                            </div>
                                            ...
                                            <div class="col-md-3 p-0">
                                              ...
                                              <p> <b>Pre-Bid Query</b> <span class="col-pink">*</span></p>
                                                <input class="datepicker form-control corrissuedate" type="text" placeholder="Please Choose a Date..." name="query_date[]" id="corrigendum_issue<?php echo $k ?>" value="<?php if(empty($filenamevalue)){ echo set_value('query_date'); }?><?php echo $filenamevalue['corrigendum_issuance_date'] ?>">
                                               
                                            </div>


                                            <div class="col-md-2 p-t-45">
                                                <button class="btn btn-success btn-circle waves-effect waves-circle waves-float upload-query-add" type="button"><i class="material-icons">add</i></button>
                                            </div>
                                        </div>
                                <?php 
                                 }
                                 ...
                                 ?>
                                  ...
                                  <div id="upload-query-row">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2"> 
                                            <button class="btn btn-default btn-circle waves-effect waves-circle waves-float upload-query-remove" type="button"><i class="material-icons col-pink">delete</i>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                  ...
                                  ?>
                                      ...
                                      <div class="col-md-1 p-0">
                                            ...
                                            <div class="col-md-3 p-0">
                                              ...
                                              <p> <b>Pre-Bid Query</b> <span class="col-pink">*</span></p>
                                                <input class="datepicker form-control corrissuedate" type="text" placeholder="Please Choose a Date..." name="query_date[]"
                                               >
                                            </div>
...
<!-- =============================== -->
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p-0">
                        <div class="card clearfix">
                             <div class="header">
                                 <h2> Attachment-Pre-Bid Response </h2>
                             </div>
                            <div class="body clearfix">
                                <div class="clearfix  m-b-15">
                                    ...
                                    ?>
                                      <div class="row">
                                            ...
                                            <div class="col-md-3 p-0">
                                              ...
                                              <p> <b>Preparation of Corrigendum and Publish</b> <span class="col-pink">*</span></p>
...
<script type="text/javascript">
    ...
    ?>
     ...
     $(".bidder-details-add").click(function () {
        ...
        $(".bidder-details-container").append('<div id="bidder-details-row"><div class="card clearfix"><div class="body"><div class="row"><div class="col-md-4"><p><b>Bidder Ref No/Name</b><span class="col-pink">*</span></p><input class="form-control bidderrefno" type="text" name="bidder_name[]" id="biddername_'+divid+'" placeholder="Bidder Name" ></div><div class="col-md-3"><p><b>Contact Info</b></p><input class="form-control bidderrefno" type="text" name="bidder_info[]" id="biddername_'+divid+'" placeholder="Bidder Contact Info" ></div><div class="col-md-5"><p><b>Attachment</b>(File type pdf,jpg,gif,docs and max 50mb)</p><input class="form-control bidderrefno" type="file" name="prebid_querydoc[]" id="biddername_'+divid+'" placeholder="Bidder Contact Info" ></div></div><div class="col-md-12 text-right"><button class="btn btn-default btn-circle waves-effect waves-circle waves-float bidder-details-remove" type="button"><i class="material-icons col-pink">delete</i></button></div></div></div>');
...
//===============
    ...
    $(this).closest('#upload-clarification-row').remove();
     ...
     //Upload Query file add remove 
    
    $(".upload-query-add").click(function () {
       divid++; 
       $(".upload-query-container").append('<div id="upload-query-row"><div class="col-md-6 p-0"><input class="form-control" type="file" name="prebid_querydoc[]"  id="uploadFile_'+divid+'"></div><div class="col-md-1 p-0"></div><div class="col-md-3 p-0"><input class="datepicker form-control corrissuedate" type="date" placeholder="Please Choose a Date..." name="query_date[]" id="corrigendum_date_'+divid+'"></div><div class="col-md-2"><button class="btn btn-default btn-circle waves-effect waves-circle waves-float upload-query-remove" type="button"><i class="material-icons col-pink">delete</i></button></div></div>');
...
//===============
    ...
    $("body").on("click", ".upload-query-remove", function() {
    $(this).closest('#upload-query-row').remove();
    });
