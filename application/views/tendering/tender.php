   <?php  $CI =& get_instance(); ?>
    ...
    <!--    Project_Information End -->      
        <?php echo form_open_multipart('Tender/manage', array('name' => 'Tender','id' => 'Tender')); ?>
                            ...
                            <div class="bidder-details-container m-b-15" id="nego_bid_value">
                               ...
                               <?php
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 p-r-0">
                                     ...
                                     <div class="col-md-3 p-r-0">
                                        <p><b>Tender Final Value</b></p>
                                        <input class="form-control txtQty bidvalue" type="text"  placeholder="Negotiated Bid Value" name="negofinalvalue[]" id="negotiationbidvalue<?php echo $k ?>" value="<?php echo number_format($Tvalue['negotiation_final_value'],2); ?>">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-4 p-r-0">
                                        <p><b>Tender Technical Mark</b></p>
                                    <input class="form-control txtQty bidvalue" type="text"  placeholder="Negotiated Bid Value" name="negotechmark[]" id="negotiationbidvalue<?php echo $k ?>" value="<?php echo number_format($Tvalue['negotiation_tech_mark'],2); ?>">
                              ...
                              <!-- =========== -->
                                ...
                                <div class="row index-row">
                                    ...
                                    <div class="col-md-3 p-r-0">
                                        <p><b>Tender Final Value</b></p>
                                    <input class="form-control txtQty bidvalue" type="text"  placeholder="Negotiated Bid Value" name="negofinalvalue[]" id="negotiationbidvalue<?php echo $k ?>" value="<?php echo number_format($Tvalue['final_score'],2); ?>">
                               ...
                               <div class="row index-row">
                                ...
                                <div class="col-md-4">
                                   ...
                                   <div class="col-md-4 p-r-0">
                                        <p><b>Tender Technical Mark</b></p>
                                    <input class="form-control txtQty bidvalue" type="text"  placeholder="Negotiated Bid Value" name="negotechmark[]" id="negotiationbidvalue<?php echo $k ?>" value="<?php echo number_format($Tvalue['tech_mark'],2); ?>">
                                ...
                                <?php 
                                 ...
                                 <!-- 07 th may code !-->
                                    <div id="bidder-details-row<?php echo $k; ?>" class="bid-rows" style="display: none;">
                                        <div class="row">
                                            <div class="col-md-3 p-r-0">
                                            ...
                                            <div class="col-md-3 p-r-0">
                                             ...
                                             <div class="col-md-3 p-r-0">
                                                <input class="form-control txtQty bidvalue" type="text" placeholder="Tender Final Value" name="negofinalvalue[]" id="negofinalvalue<?php echo $k ?>" value="<?php echo number_format($Tvalue['final_score'],2); ?>">
                            ...
                            <div class="body">
                              <div class="cloneBox1 m-b-15">
                                <div class="row clearfix">  
                                    ...
                                    <div class="col-md-4">
                                         <div class="col-md-12 p-0">
                                            <p> <b>Tender Completion Date</b></p>
                                ...
                                <div class="col-md-12 align-center">
                                    <a href="<?php echo base_url();?>published_tender/pp_tender" class="btn btn-warning waves-effect">CANCEL</a>
