        ...
        <?php echo form_open_multipart('Technical_Evalution/manage', array('name' => 'Technical_Evalution','id' => 'Technical_Evalution')); ?>
         <input type="hidden" name="project_id" value="<?php echo base64_encode($project_id); ?>" />
             ...
             <!--  -->
                 <div class="card">
                       <div class="header">
                            <h2> Bidder Information- Technical </h2>
                        </div>
                        <div class="body">
                            <div class=" m-b-15">
                               ...
                               <div class="bidder-details-container m-b-15" id="bidder_ref_number">
                                   ...
                                   <?php
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <p><b>Bidder Ref. No./Name 1</b></p>
                    <input class="form-control bidderrefno" type="text" name="bidder_refno[]" id="biddername<?php echo $k ?>" value="<?php echo $Tvalue['bidder_ref_no']; ?><?php echo $Tvalue[0]['bidder_ref_no'] ?>" placeholder="Bidder Ref No/Name" readonly> 
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <option value="Y" <?php echo set_select('technical_status','Y', ( !empty($Tvalue['technical_status']) &&
                                                $Tvalue['technical_status'] == "Y" ? TRUE : FALSE )); ?>>Qualified
                                            </option>
                                            <option value="N"  <?php echo set_select('technical_status','N', ( !empty($Tvalue['technical_status']) &&
                                                $Tvalue['technical_status'] == "N" ? TRUE : FALSE )); ?>>Disqualified
                                            </option> 
                                            </select>
                                        </div>

                                        <div class="col-md-3">
                                            <p><b>Technical Evaluation Score</b></p>
                                         <input class="form-control txtQty limittxt_progress" type="text" 
                                                name="bidder_mark[]" id="biddername<?php echo $k ?>" value="<?php echo $Tvalue['technical_mark']; ?><?php echo $Tvalue[0]['technical_mark'] ?>" 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                            <p><b>Normalised evaluation score (for QCBS)</b></p>
                                         <input class="form-control txtQty limittxt_progress" type="text" 
                                                name="bidder_score[]" id="biddername<?php echo $k ?>" value="<?php echo $Tvalue['bidder_score']; ?><?php echo $Tvalue[0]['bidder_score'] ?>" 
                                                placeholder="please Enter Normalised evaluation score"  >      
                                        </div>

                                        <div class="col-md-4">
                                            <p><b>Weighted score</b></p>
                                         <input class="form-control txtQty limittxt_progress" type="text" 
                                                name="bidder_weighted_score[]" id="biddername<?php echo $k ?>" value="<?php echo $Tvalue['bidder_weighted_score']; ?><?php echo $Tvalue[0]['bidder_weighted_score'] ?>" 
                                                placeholder="please Enter Weighted score"  >      
                                        </div>
                                    ...
                                    <div id="bidder-details-row">
                                        ...
                                        <div class="col-md-1">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input class="form-control bidderrefno" type="text" placeholder="Bidder Ref No/Name" name="bidder_refno[]"  id="biddername<?php echo $k ?>" value="<?php echo $Tvalue['bidder_ref_no']; ?>"readonly > 
                                            </div>
                                ...
                                <div class="row">
                                 ...
                                 <?php
                                     if(!empty($prequalification_data)){
                                    ?>

                                    <?php 
                                      $k = 1;
                                      $get_same_datacnt = count($prequalification_data);
                              
                                      foreach ($prequalification_data as $Tvalue) {
                                      if($k == 1){
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <p><b>Bidder Ref. No./Name</b></p>
                                                ...
                                                placeholder="Bidder Ref No/Name"readonly > 
                                        ...
                                        <div class="col-md-3">
                                            <p><b>Technical Evaluation Score</b></p>
                                                <input class="form-control txtQty limittxt_progress" type="text" 
                                                name="bidder_mark[]" id="biddername<?php echo $k ?>" value="<?php echo $Tvalue['bidder_mark']; ?><?php echo $Tvalue[0]['bidder_mark'] ?>" 
                                                placeholder="please Enter Technical Evaluation Score"  > 
                                 ...
                                 ?>
                                    <div id="bidder-details-row">
                                        <div class="row"> 
                                            ...
                                            <div class="col-md-4">
                                                <p><b>Bidder Ref. No./Name</b></p>
                                                <input class="form-control bidderrefno" type="text" placeholder="Bidder Ref No/Name" name="bidder_refno[]"  id="biddername<?php echo $k ?>" value="<?php echo $Tvalue['bidder_ref_no']; ?>"required > 
                                            </div>
