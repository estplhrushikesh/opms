                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                                ...
                                                <td>
                                               <?php $project_activity=base64_decode($_REQUEST['project_activity_id']); 
                                                if($project_activity==0){
                                                    ?>
                                        ...
                                        <!-- <tr>
                                            ...
                                            <td><select class="form-control show-tick" name="unit_id" >
             ...
             <div class="body">
               ...
               <div class="table-responsive">
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                   <thead>
                                        <tr>
                                            ...
                                            <th style="padding: 10px 5px; width: 150px">Start Date
                                            </th>
                                            <th style="padding: 10px 5px; width: 150px">End Date
                                            </th>
                                             <th style="padding: 10px 5px; width: 150px">Add Days
                                            </th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" class="form-control"id="firstDate" name="startdate1" value="<?php echo $project_aggrement_deatail[0]['project_start_date']; ?>" disabled>
                                                <input type="hidden" class="form-control"id="firstDate" name="startdate" value="<?php echo $project_aggrement_deatail[0]['project_start_date']; ?>" readonly>
                                            </td>

                                            <td>
                                                <input type="text" class="form-control" id="secondDate" name="enddate"value="<?php echo $project_physical_planning_main[0]['enddate']; ?>"required>
                                            </td>

                                            <td>
                                                <input type="text" class=" form-control" id="caldays" name="adddays" value="<?php echo $project_physical_planning_main[0]['adddays'];  ?>" readonly> 
                                            </td>
                                ...
                                <div class="col-md-2 col-md-offset-5" style="margin-top: 5px;">
                                       <input type="submit" name="submit" value="SAVE" onclick="checkSubmitStatus(event );" class="btn bg-indigo waves-effect" />
      ...
      function checkSubmitStatus( event ){
                ...
                var endDate = $("#secondDate").val();
                   ...
                   if (Date.parse(startDate) > Date.parse(endDate)) {
                      ...
                      swal(" ", "End Date should be greater than equal to Start Date.", "error");
