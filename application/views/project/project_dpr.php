            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-4">
                            <p>
                                <b>DPR Prepared By <span class="col-pink">* </span></b> 
                            </p>   
						...
						<div class="col-md-4">
                            <p>
                                <b>DPR  Start Date <span class="col-pink">* </span></b>
                            </p>
                        ...
                        <div class="col-md-4">
                            <p>
                                <b>DPR  End Date <span class="col-pink">* </span></b>
                            </p>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-4">
                            <p>
                                <b>DPR Submission Date <span class="col-pink">* </span></b>
                            </p>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="dpr_planned_cost"  id="approve" class="form-control" placeholder="Enter Estimated Project Cost" value="<?php echo $result['dpr_planned_cost']; ?>" onkeypress="allowNumbersOnly(event)">
                        ...
                        <div class="col-md-4">
                            <p>
                                <b>Project Implementation Schedule</b>
                            </p>

                            <input type="text" name="dpr_implementation_schedule"  id="approve" class="form-control" placeholder="Enter Project Implementation Schedule" value="<?php echo $result['dpr_implementation_schedule']; ?>">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="dpr_deliverable"  id="approve" class="form-control" placeholder="Enter Project Deliverables" value="<?php echo $result['dpr_deliverable']; ?>">
                        ...
                        <div class="col-md-4">
                            <p>
                                <b>Project Commercial</b>
                            </p>

                            <input type="text" name="dpr_commercial"  id="approve" class="form-control" placeholder="Enter Project Commercial" value="<?php echo $result['dpr_commercial']; ?>">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-12">
                            ...
                            <p>
                             ...
                             <textarea name="dpr_boq" id="approve" rows="8" style="height: 300;width:100% ;"><?php echo $dpr_boq ?> <?php echo $result['dpr_boq']; ?></textarea>
                        </div>
