                          ...
                          <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            <tbody>
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            <td>Project Cost (<i class="fas fa-rupee-sign"> </i>) :</td>
            ...
            <div class="body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                      ...
                      <tbody>
                        <?php
                          $count= $CI->get_activity_all_or_not_physical($project_id,$project_work_item_id); 
                         // echo $project_id;
                        ...
                        //  exit;
                         // $count_row= $CI->get_deliverable_row($project_id,$project_work_item_id);
                           ...
                           <tr>
                                <td><?php echo $i;?></td>
                                <td>
                                  <a href="#" data-toggle="modal" data-target="#exampleModal" style="color: #555" onclick="get_activity_wise_workitem_breakup('<?php echo $project_id;?>','<?php echo $activity_deatail['id'];?>','<?php echo $activity_deatail['particulars'];?>')">All</a>
                                </td>
                                <!-- <td align="right">
                                <?php
                                ...
                                <td>
                                   ...
                                   <a href="<?php echo base_url(); ?>pf_planning/delete_physical_planning?project_id=<?php echo $_REQUEST['project_id'];?>&project_work_item_id=<?php echo base64_encode($project_work_item_id); ?>&project_activity_id=<?php echo base64_encode(0); ?>&project_physical_id=<?php echo base64_encode($physical_detail[0]['id']); ?>" class="m-r-10"> <i class="fas fa-trash"></i> </a>
                                </td>
                              </tr>
                    ...
                    <?php   
                        ...
                        if(!empty($project_activity_deatail_update)){
                             //  $i=1;
                               foreach($project_activity_deatail_update as $activity_deatail){
                        ...
                        ?>
                              <tr>
                                <td><?php echo $i;?></td>
                                <td>
                                  <a href="#" data-toggle="modal" data-target="#exampleModal" style="color: #555" onclick="get_activity_wise_workitem_breakup('<?php echo $project_id;?>','<?php echo $activity_deatail['id'];?>','<?php echo $activity_deatail['particulars'];?>')"><?php if($project_activity_id==0){ echo "ALL"; }else{
                             echo $activity_deatail['particulars'];
                                ...
                                <td>
                                   ...
                                   <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" onclick="get_activity_details('<?php echo $project_id; ?>','<?php echo $project_work_item_id; ?>','<?php echo $project_activity_id; ?>','<?php echo $activity_deatail['particulars']; ?>','<?php echo $work_item_name[0]['work_item_description'];?>')">VIEW DETAILS</button>
                                   <a href="<?php echo base_url(); ?>pf_planning/add_physical_planning?project_id=<?php echo $_REQUEST['project_id'];?>&project_work_item_id=<?php echo base64_encode($project_work_item_id); ?>&project_activity_id=<?php echo base64_encode($project_activity_id); ?>&project_physical_id=<?php echo base64_encode($physical_detail[0]['id']); ?>" class="m-r-10"> <i class="fas fa-edit"></i> </a>
                                   <a href="<?php echo base_url(); ?>pf_planning/delete_physical_planning?project_id=<?php echo $_REQUEST['project_id'];?>&project_work_item_id=<?php echo base64_encode($project_work_item_id); ?>&project_activity_id=<?php echo base64_encode($project_activity_id); ?>&project_physical_id=<?php echo base64_encode($physical_detail[0]['id']); ?>" class="m-r-10"> <i class="fas fa-trash"></i> </a>
                                </td>
                              </tr>
                                        <?php 
                                               $i++;
                                     ...
                                     // else {/*
                                       //  ()){ */
                               //$i=1;
                               if(!empty($project_activity_deatail_add)){
                               foreach($project_activity_deatail_add as $activity_deatail){
                              //  $j++;
                                $project_activity_id=$activity_deatail['id'];
                                $physical_detail=$CI->get_physical_main($project_id,$project_work_item_id,$project_activity_id);
                                $unit_name=$CI->get_unit($physical_detail[0]['activity_quantity_unit_id']);
                                    ...
                                    <a href="<?php echo base_url(); ?>pf_planning/add_physical_planning?project_id=<?php echo $_REQUEST['project_id'];?>&project_work_item_id=<?php echo base64_encode($project_work_item_id); ?>&project_activity_id=<?php echo base64_encode($project_activity_id); ?>"  class="btn btn-primary"><span>CREATE PHYSICAL PLAN</span></a>
                                        ...
                                        <?php 
                                             ...
                                             <td>
                                                 ...
                                                 <a href="<?php echo base_url(); ?>pf_planning/add_physical_planning?project_id=<?php echo $_REQUEST['project_id'];?>&project_work_item_id=<?php echo base64_encode($project_work_item_id); ?>&project_activity_id=<?php echo base64_encode(0); ?>"  class="btn btn-primary"><span>CREATE PHYSICAL PLAN</span></a>
...
<?php
                                        ...
                                        ?>
                                        <?php if(empty($project_activity_deatail_update||$project_activity_deatail_add)){  ?>
                                         <tr>
