            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
               <div class="card">
                ...
                <div class="body">
                    <div class="">
                        <div class="row">
                            <div class="col-lg-12"><b>Schedule Of Events</b></div>
                        </div>
                                ...
                                <div class="col-md-7">
                                    <div class="row mobile">
                                        <div class="col-md-4">
                                            ...
                                            <input class="form-control" value="" name="tender_ref_no" type="text" placeholder="Enter Date">
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input class="form-control" value="" name="tender_ref_no" type="text" placeholder="Enter Time">
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input class="form-control" value="" name="tender_ref_no" type="text" placeholder="Enter Venue Name">
                                        </div>
                                    </div>
                                </div>
                            </div>
