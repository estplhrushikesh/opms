                                      ...
                                      ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo base_url();?>pf_planning/project_work_item?project_id=<?php echo base64_encode($pro_dtl['id']);?>" class="btn btn-warning waves-effect" title="Milestone"><i class="fas fa-cubes"></i> Milestone</a>
                                                <?php if($pro_work_item_cnt > 0){ ?>
                                                <span class="label-count2 bg-blue"><?php echo $pro_work_item_cnt; ?></span>
                                                <?php } ?>
                                                </div>
                                                <div class="notification">
                                                <a href="<?php echo base_url();?>pf_planning/project_activity?project_id=<?php echo base64_encode($pro_dtl['id']);?>" class="btn btn-success waves-effect" title="Deliverables"><i class="fas fa-boxes"></i> Deliverables</a>
