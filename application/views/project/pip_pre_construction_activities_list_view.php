        ...
        <div class="container-fluid">
           <div class="col-md-6">
				<div class="block-header">
					<h4>Project List - Pre Project Activities</h4>
				</div>
            </div>
            <div class="col-md-6">
                            ...
                            <div class="">
                                <table id="project_list" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        $settings_action = base_url().'pre_project_activity/settings?project_id='.base64_encode($key->project_id);
                                   ...
                                   <!--  end for pending -->
                                    ...
                                    <?php 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url();?>Pre_project_activity_erp/manage/?project_id=<?php echo base64_encode($key->project_id);?>" <?php echo $modify_btn_class; ?> class="btn bg-primary" title="Modify"><i class="fa fa-pencil-alt"></i> Modify</a>
                                            </td>
                                        </tr>
