...
public function get_projects($circle_id,$division_id) {
    ...
    $query = $this->db->query("select pcs.id as projectid,pcs.project_name,project_type_master.project_type,area_master.name,update_status_issues.current_status,update_status_issues.issues
    from project_conceptualisation_stage pcs
