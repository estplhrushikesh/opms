...
/* checking activity id exist or not */
    ...
    public function get_financial_act($project_id, $project_work_item_id, $activity_id){
      $this->db->select('project_financial_planning_main.*','financial_amount');
      $this->db->where('project_financial_planning_main.project_id', $project_id);
      $this->db->where('project_financial_planning_main.project_work_item_id', $project_work_item_id);
      $this->db->where('project_financial_planning_main.deliverable_name', $activity_id);
