                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            <div class="col-md-12">
                                <p>
                                    <b>1.Draft Contract Preparation Status <span class="col-pink">* </span></b>
                            ...
                            <div class="col-md-12">
                                <p>
                                    <b>2.Final Draft Contract Shared To Bidder <span class="col-pink">* </span></b>
                                    <span class="ntip"><i class="fa fa-info-circle" title=""></i>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-12">
                                <p>
                                    <b>3.Final Draft Contract Sharing Date <span class="col-pink">* </span></b>
                            ...
                            <div class="col-md-12">
                                <p>
                                    <b>4.Contract Signing Date<span class="col-pink">* </span></b>
                                    <span class="ntip"><i class="fa fa-info-circle" title=""></i>
                          ...
                          <div class="row clearfix">
                            <div class="col-md-12"> <p>
                                    <b>5.Contract Effective Date<span class="col-pink">* </span></b>
                                </p>
                            ...
                            <div class="col-md-12">
                                <p>
                                    <b>6.Stipulated Date Of Completion as per Agreement<span class="col-pink">* </span></b>
                                </p>
                        ...
                        <div class="row clearfix">
                            <div class="col-md-12">
                                <p>
                                    <b>7.Contract Value  (₹)<span class="col-pink">* </span></b>
                                   
                                </p>

                                <input type="text" maxlength="14" value="<?php echo !empty($result['agreement_cost']) ? number_format($result['agreement_cost'],2) : number_format($_REQUEST['agreement_cost'],2) ?>" name="agreement_cost" class="form-control txtQty" placeholder="Enter Agreement cost" >
                                <span id="err_span" style='color:#ff0000'><?php echo form_error('agreement_cost'); ?></span>
                            </div>
                            <div class="col-md-12">
                                <p>
                                    <b>8.Agreement End Date<span class="col-pink">* </span></b>
                        ...
                        <div class="row clearfix">
                             <div class="col-md-12">
                                <p>
                                    <b>9.PBG Verified <span class="col-pink">* </span></b>
                                    <span class="ntip"><i class="fa fa-info-circle" title=""></i>
                            ...
                            <div class="col-md-12">
                                <p>
                                    <b>10.PBG Submitted By Bidder <span class="col-pink">* </span></b>
                        ...
                        <div class="row clearfix">
                            <div class="col-md-12">
                                <p>
                                    <b>11.Selected Bidders Representative Name </b>
                            ...
                            <div class="col-md-12">
                                <p>
                                    <b>12.PBG Amount  (₹)<span class="col-pink">* </span></b>
                                   
                                </p>

                               <input type="text" maxlength="14" name="bg_amount" value="<?php echo !empty($result['bg_amount']) ? number_format($result['bg_amount'],2) : number_format($_REQUEST['bg_amount'],2) ?>" class="form-control txtQty" placeholder="Enter BG amount">
                        ...
                        <div class="row clearfix">
                            <div class="col-md-12">
                                <p>
                                    <b>13.PBG Submission Date <span class="col-pink">* </span></b>
                            ...
                            <div class="col-md-12">
                                <p>
                                    <b>14.Planning In-Charge  <span class="col-pink">* </span></b>
                                </p>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-12">
                                <p>
                                    <b>15.Notice To Proceed / Date Of Commencement Of Project<span class="col-pink">* </span></b>
                            ...
                            <div class="col-md-12 select2-custom">
                                <p>
                                    <b>16.Payment Schedule</b>
                        ...
                        <div class="row clearfix">
                            <div class="col-md-12">
                             <p> <b>17.Remarks (Maximum Word Limit 250)</b>
                                </p>
