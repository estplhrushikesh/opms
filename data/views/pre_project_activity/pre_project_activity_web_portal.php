...
<?php echo form_open_multipart('Pre_project_activity_web_portal/manage', array('name' => 'Pre_project_activity_web_portal','id' => 'Pre_project_activity_web_portal')); ?>
                        ...
                        <div class="body">
                            <div class="row clearfix">
                               <div class="col-md-4">
                                    ...
                                    <input type="hidden" name="landalination_id" value="<?php echo $get_forestland[0]['id'] ?>">
                                    
                                    <input class="form-control"  name="dept_approve" id="dept_approve" type="text" value="<?php if(empty($get_forestland)){ echo set_value('dept_approve'); }?><?php echo $get_forestland[0]['dept_approve'] ?>"  placeholder="Department Approval">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control"  name="dept_budge" id="dept_budge" type="text" value="<?php if(empty($get_forestland)){ echo set_value('dept_budge'); }?><?php echo $get_forestland[0]['dept_budge'] ?>"  placeholder="Department Budget">
                                    <input type="hidden" id="total_area_hidden">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control"  name="dept_stakehold" id="dept_stakehold" type="text" value="<?php if(empty($get_forestland)){ echo set_value('dept_stakehold'); }?><?php echo $get_forestland[0]['dept_stakehold'] ?>"  placeholder="Department Stake Holder">
                                    <input type="hidden" id="total_area_hidden">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <?php echo form_error('target_date', '<div class="error">', '</div>'); ?>
                                     <input type="text" name="target_date" value="<?php if(empty($get_forestland)){ echo set_value('target_date'); }?><?php echo $get_forestland[0]['target_date'] ?>" class="datepicker form-control" placeholder="Please choose a date...">
                                </div>
                            ...
                            <div class="row clearfix">
                               ...
                               <div class="col-md-4">
                                    ...
                                    <?php echo form_error('progress', '<div class="error">', '</div>'); ?>
                                     <input class="form-control txtQty limittxt_progress" name="progress" type="text" value="<?php if(empty($get_forestland)){ echo set_value('progress'); }?><?php echo $get_forestland[0]['progress_%'] ?>" placeholder="Progress">
                                </div>
                                ...
                                <div class="col-md-4">
                                    <p>
                                     ...
                                     <select class="form-control show-tick" name="activity_status">
                                        <option value="Yes" <?php echo set_select('activity_status','Yes', ( !empty($get_forestland[0]['activity_status']) &&
                                      $get_forestland[0]['activity_status'] == "Yes" ? TRUE : FALSE )); ?>>Yes</option>

                                        <option value="No" <?php echo set_select('activity_status','No', ( !empty($get_forestland[0]['activity_status']) &&
                                      $get_forestland[0]['activity_status'] == "No" ? TRUE : FALSE )); ?>>No</option>
                                    </select>
                                </div>
                            </div>
