...
<?php echo form_open_multipart('Pre_project_activity_infrastructure/manage', array('name' => 'Pre_project_activity_infrastructure','id' => 'Pre_project_activity_infrastructure')); ?>
                   ...
                   <!--         <div class="row clearfix m-b-30"> 
                            ...
                            <div class="row clearfix">
                              ...
                              <div class="col-md-4">
                                    ...
                                    <input type="hidden" name="landalination_id" value="<?php echo $tree_cutting[0]['id'] ?>">
                                    
                                    <input class="form-control"  name="dept_approve" id="dept_approve" type="text" value="<?php if(empty($tree_cutting)){ echo set_value('dept_approve'); }?><?php echo $tree_cutting[0]['dept_approve'] ?>"  placeholder="Department Approval">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control"  name="dept_budge" id="dept_budge" type="text" value="<?php if(empty($tree_cutting)){ echo set_value('dept_budge'); }?><?php echo $tree_cutting[0]['dept_budge'] ?>"  placeholder="Department Budget">
                                    <input type="hidden" id="total_area_hidden">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control"  name="dept_stakehold" id="dept_stakehold" type="text" value="<?php if(empty($tree_cutting)){ echo set_value('dept_stakehold'); }?><?php echo $tree_cutting[0]['dept_stakehold'] ?>"  placeholder="Department Stake Holder">
                                    <input type="hidden" id="total_area_hidden">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <?php echo form_error('target_date', '<div class="error">', '</div>'); ?>
                                     <input type="text" name="target_date" value="<?php if(empty($tree_cutting)){ echo set_value('target_date'); }?><?php echo $tree_cutting[0]['target_date'] ?>" class="datepicker form-control" placeholder="Please choose a date...">
                                </div>
                            ...
                            <div class="row clearfix">
                               ...
                               <div class="col-md-4">
                                    ...
                                    <?php echo form_error('progress', '<div class="error">', '</div>'); ?>
                                     <input class="form-control txtQty limittxt_progress" name="progress" type="text" value="<?php if(empty($tree_cutting)){ echo set_value('progress'); }?><?php echo $tree_cutting[0]['progress_%'] ?>" placeholder="Progress">
                                </div>
                                ...
                                <div class="col-md-4">
                                    <p>
                                     ...
                                     <select class="form-control show-tick" name="activity_status">
                                        <option value="Yes" <?php echo set_select('activity_status','Yes', ( !empty($tree_cutting[0]['activity_status']) &&
                                      $tree_cutting[0]['activity_status'] == "Yes" ? TRUE : FALSE )); ?>>Yes</option>

                                        <option value="No" <?php echo set_select('activity_status','No', ( !empty($tree_cutting[0]['activity_status']) &&
                                      $tree_cutting[0]['activity_status'] == "No" ? TRUE : FALSE )); ?>>No</option>
                                    </select>
                                </div>
                            </div>
