								  ...
								  $status_view = "In Progress";
                                      ...
                                      ?>
                                        ...
                                        <?php if($role_id == '31' || $role_id == '32') { ?> 
                                          ...
                                          <a class="btn bg-primary waves-effect" title="" href="<?php echo base_url();?>Pre_bid_conference/details?project_id=<?php echo base64_encode($app->project_id); ?>">
                                            <i class="fa fa-pencil-alt"></i> Details
                                            </a>
                                            <?php
                                              }
                                          ?>
