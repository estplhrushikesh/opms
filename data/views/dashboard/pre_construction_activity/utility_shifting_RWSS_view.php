    ...
    <div class="table-responsive">
        ...
        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                ...
                <tr>
                    ...
                    <td><?php echo $utility_shifting_RWSS_data[0]['activity_status']; ?></td>
                </tr> 
                <tr>
