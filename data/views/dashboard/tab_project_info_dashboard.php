  ...
  ?>
            ...
            <h2>Project Information</h2>
                    ...
                    <!-- <li role="presentation" class="">
                        ...
                        <a href="#project_pre_construction" data-toggle="tab" aria-expanded="false">
                            <i class="material-icons">playlist_add_check</i>  Pre Project Activities
                        </a>
                ...
                <!-- Project creation -->
                <div role="tabpanel" class="tab-pane fade in" id="project_creation">
                ...
                <table class="table table-bordered table-striped table-hover js-basic-example dataTable camelcase">
                    ...
                    <tr>
                        <td> <i class="material-icons" style="position: relative;top: 8px;"> chevron_right</i> Project Category</td>
                    ...
                    <tr>
                        ...
                        <td> <i class="material-icons" style="position: relative;top: 8px;">chevron_right</i> Project Location  </td>
    ...
    <!-- End for Users -->
                            ...
                            <!-- For image  -->
                            <?php
                            if(is_array($project_creation_attachment)){
                        ...
                        <div class=" table-responsive">
                            <table class="table table-bordered table-striped table-hover camelcase">
                                ...
                                <tbody>
                                    <?php
                                    $i = 1;
                                    foreach ($project_creation_attachment as $creation_attachment) {
                                     $creation_attachment_file_link = base_url().'uploads/attachment/'.$creation_attachment->file_path;

                                     $path = 'uploads/attachment/'.$creation_attachment->file_path;
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $creation_attachment->file_name; ?></td>
                                        <td>
                                            <div class="col-md-3"> 
                                                <a href="<?php echo $creation_attachment_file_link; ?>" class="btn btn-primary waves-effect" title="Download" download><i class="fas fa-download"></i> Download</a>
                                            </div>
                                        </td>
                                    </tr>
                            ...
                            <div class="table-responsive m-b-30">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable camelcase">
                                    ...
                                    <tr>
                                        ...
                                        <td><i class="material-icons" style="position: relative;top: 8px;">chevron_right</i> Implementation Site</td>
                                        <td><?php echo !empty($project_detail[0]['project_office']) ? $project_detail[0]['project_office'] : "NA"; ?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><i class="material-icons" style="position: relative;top: 8px;">chevron_right</i> Project Department</td>
                                        <td><?php echo !empty($project_detail[0]['wing_name']) ? $project_detail[0]['wing_name'] : "NA"; ?></td>
                                        <td><i class="material-icons" style="position: relative;top: 8px;">chevron_right</i>Indicative Project Cost (₹)</td>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="project_dpr_data">
                            <div class="table-responsive m-b-30">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable camelcase">
                                    ...
                                    <tr>
                                        <td> <i class="material-icons" style="position: relative;top: 8px;">chevron_right</i>Project Planned Cost</td>
                                        <td><?php 
                                      
                                       
                                        
                                        echo  !empty($project_dpr_data[0]['dpr_planned_cost']) ? $project_dpr_data[0]['dpr_planned_cost'] : "NA";  ?></td>
                                        <td> <i class="material-icons" style="position: relative;top: 8px;">chevron_right</i> Project Implementation Schedule</td>
                                        <td>
                                        <?php 
                                      
                                       
                                        
                                      echo  !empty($project_dpr_data[0]['dpr_implementation_schedule']) ? $project_dpr_data[0]['dpr_implementation_schedule'] : "NA";  ?></td>
                                    </tr>
                                     <tr>
                                        <td> <i class="material-icons" style="position: relative;top: 8px;">chevron_right</i>Project Deliverables
                                      ...
                                      echo  !empty($project_dpr_data[0]['dpr_deliverable']) ? $project_dpr_data[0]['dpr_deliverable'] : "NA";  ?> 
                                    </td>
                                        <td> <i class="material-icons" style="position: relative;top: 8px;">chevron_right</i> Project Commercial</td>
                                        <td>
                                      ...
                                      echo  !empty($project_dpr_data[0]['dpr_commercial']) ? $project_dpr_data[0]['dpr_commercial'] : "NA";  ?> </td>
                                    </tr>

                                    <tr>
                                        <td> <i class="material-icons" style="position: relative;top: 8px;">chevron_right</i>Bill Of Quantities
                                      ...
                                      echo  !empty($project_dpr_data[0]['dpr_boq']) ? $project_dpr_data[0]['dpr_boq'] : "NA";  ?> 
                                    </td>
                                    <td></td>
                                    <td></td>
                              ...
                              <div class="row ">
                                <div class="body">
                                    ...
                                    if($project_pre_construction_setting[0]['govt_land_alienation'] == 'Y'){
                                        ...
                                        $chk_no2 = $CI->Projectdashboard_model->check_pre_construction_value_exist_or_not_in_tbl('pre_project_activity_erp','project_id',$project_id);
                                        $progress2 = $CI->Projectdashboard_model->get_specific_data_against_value('pre_project_activity_erp','project_id',$project_id,'progress_%');
                                        if(!empty($progress2)){
                                            $progress2 = '('.$progress2.'%)';
                                        }
                                            if($chk_no2 > 0){
                                    ...
                                    ?>
                                        <li class="m-b-10"><i class="fas fa-arrow-alt-circle-right"></i> <a href="#!" onclick="show_info('gov_land_alienation')" class="<?php echo $cls2; ?>"> ERP <?php echo $progress2; ?></a>
                                        </li>
                                        <?php } 
                                    if($project_pre_construction_setting[0]['private_land_direct_purchase'] == 'Y'){

                                        $chk_no2 = $CI->Projectdashboard_model->check_pre_construction_value_exist_or_not_in_tbl('	pre_project_activity_mis','project_id',$project_id);
                                        $progress2 = $CI->Projectdashboard_model->get_specific_data_against_value('	pre_project_activity_mis','project_id',$project_id,'progress_%');
                                        if(!empty($progress2)){
                                            $progress2 = '('.$progress2.'%)';
                                        }
                                            if($chk_no2 > 0){
                                    ...
                                    ?>
                                        <li class="m-b-10"><i class="fas fa-arrow-alt-circle-right"></i> <a href="#!" onclick="show_info('private_land_dp')" class="<?php echo $cls2; ?>"> MIS <?php echo $progress2; ?> </a></li>
                                        <?php } 
                                    ...
                                    ?>
                                        <li class="m-b-10"><i class="fas fa-arrow-alt-circle-right"></i> <a href="#!" onclick="show_info('private_land_la')" class="<?php echo $cls2; ?>"> Website <?php echo $progress2; ?> </a></li>
                                    <?php } ?>
                             ...
                             <div class="col-md-4">
                               <div class="row ">
                                <div class="body">
                                    ...
                                    ?>
                                        <li class="m-b-10"><i class="fas fa-arrow-alt-circle-right"></i> <a href="#!" onclick="show_info('forest_land')" class="<?php echo $cls2; ?>"> Web Portal <?php echo $progress2; ?> </a>
                                        </li>
                                        <?php }
                                    ...
                                    ?>
                                        <li class="m-b-10"><i class="fas fa-arrow-alt-circle-right"></i> <a href="#!" onclick="show_info('tree_cutting')" class=" <?php echo $cls2; ?>"> Infrastructure <?php echo $progress2; ?></a>
                                        </li>
                                        <?php }
                                        ...
                                        $progress2 = $CI->Projectdashboard_model->get_specific_data_against_value('pre_construction_activities_environment_clearance','project_id',$project_id,'progress_%');
                                        if(!empty($progress2)){
                                            $progress2 = '('.$progress2.'%)';
                                         }
                                            if($chk_no2 > 0){
                                    ...
                                    ?>
                                        <li class="m-b-10"><i class="fas fa-arrow-alt-circle-right"></i> <a href="#!" onclick="show_info('environmental_clearance')" class="<?php echo $cls2; ?>"> Licence Availability <?php echo $progress2; ?></a></li>
                                        <?php }
                                    ...
                                    ?>
                                        <li class="m-b-10"><i class="fas fa-arrow-alt-circle-right"></i> <a href="#!" onclick="show_info('utility_shifting_elec')" class="<?php echo $cls2; ?>"> Building Availability <?php echo $progress2; ?></a></li>
                                    <?php } ?>
                            ...
                            <div class="col-md-4">
                               <div class="row ">
                                <div class="body">
                                    ...
                                    ?>
                                        <li class="m-b-10"><i class="fas fa-arrow-alt-circle-right"></i> <a href="#!" onclick="show_info('utility_shifting_PH')" class="<?php echo $cls2; ?>">Site Readiness <?php echo $progress2; ?></a></li>
                                    <?php }
                                    ...
                                    ?>
                                    <li class="m-b-10"><i class="fas fa-arrow-alt-circle-right"></i> <a href="#!" onclick="show_info('utility_shifting_RWSS')" class="<?php echo $cls2; ?>"> Power Backup <?php echo $progress2; ?></a></li>
