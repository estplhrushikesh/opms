                      ...
                      <div class="table-responsive">
                          <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            <tbody>
                                     ...
                                     <!--    <tr>
                                          <td>Location : </td>
                                          <td> // echo $project_progress_location[0]['area_name']</td>
                                        </tr> -->
                                        <tr>
                                            <td>Type : </td>
          ...
          <!-- <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="header">
                             <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8" ><h2>Project Milestone With Deliverables</h2>
                             </div>
                              ...
                              ?>
                                      <tr>
                                        ...
                                        <td>
                                          ...
                                          <a href="<?php echo base_url();?>Monitoring/earned_financial_progress?project_id=<?php echo base64_encode($work_item_detail['project_id']);?>&project_work_item_id=<?php echo base64_encode($work_item_detail['work_item_id']); ?>" class="btn btn-warning waves-effect" style="text-align:center" title=""><i class="fas fa-eye"></i>Deliverable</a>

                                          <a href="<?php echo base_url();?>Monitoring/add_financial_monitoring?project_id=<?php echo base64_encode($work_item_detail['project_id']);?>&project_work_item_id=<?php echo base64_encode($work_item_detail['work_item_id']); ?>" class="btn btn-success waves-effect" style="text-align:center" title=""><i class="fas fa-eye"></i>Financial</a>
                                        </td>
