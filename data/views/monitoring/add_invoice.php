                    ...
                    <div class="body">
                        ...
                        <div class="section_clone">
                            ...
                            <div class="col-md-2 col-md-offset-5 text-center" style="margin-top: -21px;">
                                 ...
                                 <a href="<?php echo base_url().'Monitoring/add_financial_monitoring?project_id='.base64_encode($project_id).'&project_work_item_id='.base64_encode($project_work_item_id)?>" class="btn btn-success">BACK</a>
                        </div>
