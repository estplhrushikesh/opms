            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                       ...
                       <form  method="POST" onsubmit="quesChars(CKEDITOR.instances.editor1.getData())" enctype="multipart/form-data">  
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-4">
                                   ...
                                   <input class="form-control" type="text" placeholder="Enter Project Implementation Site" name="project_office" value="<?php echo $project_office ?>">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-4">
                                    <p>
                                      ...
                                      <input type="text" id="approve" class="datepicker form-control" name="project_submission_date" placeholder="Please choose a date..."value="<?php echo $project_submission_date ?>">
                            ...
                            <div class="row clearfix">
                             ...
                             <textarea name="project_description" id="project_description" rows="8" style="height: 300;width:100% ;"><?php echo $project_description ?></textarea>  
                                            ...
                                            <div id="container_<?php echo $i; ?>" class="row clearfix">
                                                ...
                                                <div class="col-md-5">
                                                    <p id="fnameusr_<?php echo $i; ?>" <?php echo $style; ?> >
                                                        <b>Office Incharges Name</b>
                                                    </p>

                                                    <select id="user_name_<?php echo $i; ?>" name="user_name[]" class="form-control show-tick">
                                                        <option value="0">Select Office Incharges Name</option>
                ...
                <div class="card">
                   ...
                   //print_r($steps_files);
                    ...
                    <div class="col-md-12 align-center">
                        ...
                        <button id="submit_btn"  onsubmit="quesChars(CKEDITOR.instances.editor1.getData())"  class="btn bg-indigo waves-effect"  type="submit" name="submit_btn" value="Submit" ><?php if(is_numeric($project_id)){ echo 'UPDATE'; }else{ echo 'SUBMIT';  } ?></button>
