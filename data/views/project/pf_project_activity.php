                          ...
                          <?php echo form_open('pf_planning/add_project_activity',array('name'=> 'add_project_activity','id'=>'add_project_activity_form')); ?>
                              <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <thead>
                                        <tr>
                                            <th>Deliverable Name:<span style="color: red;">*</span> 
                                            </th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <input type="text" class="form-control" placeholder="Deliverable Name" name="particular" required="" value="<?php if(!empty($project_activity_detail_edit[0]['particulars'])){echo $project_activity_detail_edit[0]['particulars'];}else{echo "";}?>"/></td>
                                            <!-- <td>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                   <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: center; width: 450px">Particulars Name</th>
