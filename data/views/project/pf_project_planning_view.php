                  ...
                  <table class="table table-bordered table-striped table-hover js-basic-example dataTable" name="planning">
                    <tbody>
                      <tr style="background: #e6e6e6;">
                        ...
                        <td rowspan="2" style="text-align: center; vertical-align: middle;" class="p-b-0"><strong>Milestone</strong></td>

                        <!-- <td colspan="2" style="text-align: center; background: #b4c4e4;width:15%" class="p-b-0"><strong>Physical</strong></td> -->

                        <td  style="text-align: center; background: #b4c4e4" class="p-b-0"><strong>Financial</strong></td>
                        <td  style="text-align: center; background: #b4c4e4" class="p-b-0"><strong>Physical</strong></td>
                        <td rowspan="2" style="text-align: center; vertical-align: middle;" class="p-b-0"><strong>Planning</strong></td>
                      </tr>
                      <tr style="background: #e6e6e6;">
                       
                        <td style="text-align: center; background: #b5bec9; border-right: 1px solid #ddd;">Planned Deliverables</td>
                        <td style="text-align: center; background: #b5bec9; border-right: 1px solid #ddd;">Planned Deliverables</td>
                     ...
                     ?>
                              <tr>
                                ...
                                <td align="center"><?php echo $activity_cnt; ?></td>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo base_url();?>pf_planning/physical_listing?project_id=<?php echo $_REQUEST['project_id'];?>&project_work_item_id=<?php echo base64_encode($work_item_deatail['work_item_id']); ?>" class="btn btn-warning waves-effect" title="Physical Planning"><i class="fas fa-tasks"></i> Physical </a>
