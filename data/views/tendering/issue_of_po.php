<?php  $CI =& get_instance(); ?>
     ...
     <section class="content">
        ...
        <?php echo form_open_multipart('Issue_of_PO/manage', array('name' => 'Issue_of_PO','id' => 'Issue_of_PO')); ?>
                         ...
                         <div class="body">
                            ...
                            <div class="row clearfix">  
                               ...
                               <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                  <p><b>Upload PO</b>(File type pdf,jpg,gif,docs and max file size 50mb)</p>
                            ...
                            <div class="body">
                              <div class="cloneBox1 m-b-15">
                                ...
                                <div class="col-md-12 align-center">
                                    <a href="<?php echo base_url();?>published_tender/pp_issue_po" class="btn btn-warning waves-effect">CANCEL</a>
