...
class Monitoring extends MY_Controller {
    ...
    $total_amount=$val['invoice_value'];
     ...
     <td style="text-align: center; vertical-align: middle;">'.$slNo.'
         ...
         <a href="'. base_url().'Monitoring/edit_invoice?project_id='.base64_encode($project_id).'&work_item_id='.base64_encode($work_item_id).'&activity_id='.base64_encode($activity_id).'&invoice_no='.base64_encode($invoice_no).'" style="text-align: right; vertical-align: middle; display: flex;
         align-items: center;
...
/* 
   ...
   redirect('Monitoring/add_financial_monitoring?project_id='.base64_encode($_REQUEST['a']).'&project_work_item_id='.base64_encode($_REQUEST['b']));
