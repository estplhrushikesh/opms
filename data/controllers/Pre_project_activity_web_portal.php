...
class Pre_project_activity_web_portal extends MY_Controller
{   
    ...
    $projectData_exist_flag = $this->Land_forest_model->checkProjectExits($project_id);
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->common_template('pre_project_activity/pre_project_activity_web_portal', $data);
    ...
    $this->Land_forest_model->forestland_purchase_location($addData);
         ...
         if($project_id){
                ...
                redirect('Pre_project_activity_web_portal/manage?project_id=' . base64_encode($project_id));
            }
