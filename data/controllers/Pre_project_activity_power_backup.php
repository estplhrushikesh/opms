...
class Pre_project_activity_power_backup extends MY_Controller
{   
    ...
    public function manage()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
           ...
           $this->load->common_template('pre_project_activity/pre_project_activity_power_backup', $data);
    ...
    $this->Utility_shifting_rwss_model->addutility_ph_location($addData);
      ...
      $this->session->set_flashdata('success', 'Pre Construction Activities Utility Shifting Data saved successfully');
         ...
         if($project_id){
                ...
                redirect('Pre_project_activity_power_backup/manage?project_id=' . base64_encode($project_id));
            }
