...
class Pre_project_activity_infrastructure extends MY_Controller
{   
    ...
    $projectData_exist_flag = $this->Tree_cutting_model->checkProjectExits($project_id);
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->common_template('pre_project_activity/pre_project_activity_infrastructure', $data);
    ...
    $this->Tree_cutting_model->treecutting_location($addData);
         ...
         if($project_id){
                ...
                redirect('Pre_project_activity_infrastructure/manage?project_id=' . base64_encode($project_id));
            }
