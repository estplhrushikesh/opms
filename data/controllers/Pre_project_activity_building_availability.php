...
class Pre_project_activity_building_availability extends MY_Controller
{   
    ...
    public function manage()
    {
       ...
       $projectData_exist_flag = $this->Utility_shift_elec_model->checkProjectExits($project_id);
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->common_template('pre_project_activity/pre_project_activity_building_availability', $data);
...
// End of location details
         ...
         if($project_id){
                ...
                redirect('Pre_project_activity_building_availability/manage?project_id=' . base64_encode($project_id));
            }
