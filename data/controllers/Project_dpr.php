    ...
    public function project_dpr(){
       ...
       elseif($project_creator_id == $user_id || $project_approver_id == $user_id){
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $db_data['dpr_implementation_schedule'] =  $this->checkEmptyValue($_REQUEST['dpr_implementation_schedule']);
            $db_data['dpr_deliverable'] =  $this->checkEmptyValue($_REQUEST['dpr_deliverable']);
            $db_data['dpr_commercial'] =  $this->checkEmptyValue($_REQUEST['dpr_commercial']);
            $db_data['dpr_boq'] =  $this->checkEmptyValue($_REQUEST['dpr_boq']);
            $db_data['dpr_planned_cost'] =  $this->checkEmptyValue($_REQUEST['dpr_planned_cost']);
