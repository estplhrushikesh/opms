...
function fetch_data_from_post(){
   ...
   $data['scheme_id'] = $this->checkEmptyValue($this->input->post('scheme_id',TRUE));
    ...
    $data['project_description'] = $this->checkEmptyValue($this->input->post('project_description',TRUE));
    $data['project_submission_date'] = $this->checkEmptyValue($this->input->post('project_submission_date',TRUE));
    $data['project_office'] = $this->checkEmptyValue($this->input->post('project_office',TRUE));
...
function fetch_data_from_db($update_id){
    ...
    $data['project_submission_date'] = $row->project_submission_date;
    $data['project_office'] = $row->project_office;
