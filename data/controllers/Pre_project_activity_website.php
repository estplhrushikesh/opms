...
class Pre_project_activity_website extends MY_Controller
{   
    ...
    $projectData_exist_flag = $this->Privateland_la_model->checkProjectExits($project_id);
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->common_template('pre_project_activity/pre_project_activity_website', $data);
    ...
    $this->Privateland_la_model->land_acquisition_location($addData);
         ...
         if($project_id){
                ...
                redirect('Pre_project_activity_website/manage?project_id=' . base64_encode($project_id));
            }
